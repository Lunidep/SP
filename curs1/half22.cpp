...
extern double tolerance/*63*/;
extern double total__iterations/*64*/;
...
double __PIP__try/*32*/ (double neg__point, double pos__point){
 double midpoint/*33*/ = 0.;
	 double test__value/*34*/ = 0.;
 ...
 (close__enough_Q(neg__point,
	...
	: (test__value = f(midpoint),
	 ((0. < test__value)
	? __PIP__try(neg__point, midpoint)
	: ((test__value < 0.)
	? __PIP__try(midpoint, pos__point)
	: midpoint))));
	 }
...
double tolerance/*63*/ = +.001e0;
	 
double total__iterations/*64*/ = 0.;
